					...
					<table className='w-full caption-bottom border-0'>
						<thead className='[&amp;_tr]:border-b'>
							<tr className='border-b border-white/50'>
								...
								<th className='[&amp;:has([role=checkbox])]:pr-0 h-12 p-2 text-center align-middle md:px-4'>Free tier</th>
								<th className='[&amp;:has([role=checkbox])]:pr-0 h-12 p-2 text-center align-middle md:px-4'>Usage beyond Free tier*</th>
							</tr>
						</thead>
						...
						<caption className='mt-8 text-left text-sm italic text-white/60'>* Usage beyond free tier is claculated per unit which costs LKR 100.</caption>
					</table>
